...
The central question of this project: **how much of the VAE's blurriness is architectural, and does a CNF on the same data produce sharper, more faithful galaxy morphologies?**
...
- Encode natural language descriptions or class description of galaxy morphology into dense embedding vectors via a pretrained LLM/CLIP model
